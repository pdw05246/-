                ...
                <div class="register-popUp">
                    <div class="web-left">
                        ...
                        <?php
                            ...
                            $sql ="SELECT sub_name, credit_num, appli_grade, class_type FROM sub_tbl
                                ...
                                WHERE stu_id = '".$_SESSION['stu_id']."'  AND class_type NOT IN ('전선', '전필', '학부공통')
                                AND sub_name NOT IN (SELECT fk_sub_name FROM save_tbl WHERE fk_stu_id = '".$_SESSION['stu_id']."');";
